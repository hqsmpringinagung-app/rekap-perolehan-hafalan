...
<body class="bg-gray-50 font-sans min-h-screen text-gray-800">
    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-fit">
                <h2 id="formTitle" class="text-xl font-semibold mb-4 text-emerald-800 border-b pb-2 flex items-center gap-2">
                ...
                <form id="hafalanForm" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" id="awalSetoran" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" placeholder="juz 2 hlm 5">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Akhir Setoran</label>
                            <input type="text" id="akhirSetoran" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" placeholder="juz 2 hlm 10">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" id="mingguIni" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" placeholder="5 halaman">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-2">
                        ...
                        <button type="submit" id="submitBtn" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2.5 rounded-lg transition text-sm shadow-sm cursor-pointer">
                            💾 Simpan Data
                        </button>
                    </div>
                </form>
    ...
    <script>
                        ...
                        <tr class="hover:bg-gray-50/70 transition">
                            ...
                            <td class="py-3 px-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <button onclick="editData(${index})" class="text-amber-600 hover:text-amber-800 font-semibold text-xs transition cursor-pointer">✏️ Edit</button>
                                    <span class="text-gray-300">|</span>
                                    <button onclick="hapusData(${index})" class="text-rose-500 hover:text-rose-700 font-semibold text-xs transition cursor-pointer">❌ Hapus</button>
                                </div>
                            </td>
                        </tr>
                    `;
        ...
        function editData(index) {
            ...
            document.getElementById('awalSetoran').value = item.awal;
            ...
            submitBtn.className = "bg-amber-600 hover:bg-amber-700 text-white font-semibold py-2.5 rounded-lg transition text-sm shadow-sm cursor-pointer";
